...
public class HelpsListFragment extends Fragment {
    ...
    private void initUI() {
        ...
        listViewSettings.setAdapter(new AdapterHelps(settingList));
    ...
    public void setHelpFragmentTitleList(List<Integer> settingList) {
    ...
    public class AdapterHelps extends BaseAdapter {

        private final List<Integer> settingsNameList;

        public AdapterHelps(List<Integer> list) {
